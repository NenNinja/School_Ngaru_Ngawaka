...
# any comment including NOTE: is a personal note and can be ignored, but it may be helpful to read it if you want to understand the code better :3
...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # header frame
        headerFrame = frame(self, headerColor1, column=0, row=0, columnspan=3, sticky="nsew", columnNum=10)
        ...
        # buttons frame
        buttonFrame = frame(self, bg=backgroundColor1, column=1, row=1, rowspan=2, sticky="nsew", rowNum=10)
        ...
        settingsFrame = frame(self, bg=backgroundColor1, column=2, row=1, rowspan=2, sticky="nsew", columnNum=4, rowNum=10)
